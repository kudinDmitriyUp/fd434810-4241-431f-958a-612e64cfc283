...
export const metadata: Metadata = {
  title: "Vinoteca Madrid - Authentic Spanish Wine Bar & Tasting Experience",
  description: "Discover exceptional Spanish wines in Madrid's premier wine bar. Curated selections, expert pairings, and intimate atmosphere for wine enthusiasts.",
  keywords: ["wine bar Madrid", "Spanish wines", "wine tasting", "Rioja", "sommelier", "wine pairing", "Madrid restaurants"],
  metadataBase: new URL("https://vinotecamadrid.es"),
  alternates: {
    canonical: "https://vinotecamadrid.es"
  },
  openGraph: {
    title: "Vinoteca Madrid - Authentic Spanish Wine Experience",
    description: "Discover exceptional Spanish wines in Madrid's premier wine bar. Curated selections, expert pairings, and intimate atmosphere.",
    siteName: "Vinoteca Madrid",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763251759907-c79nqvl8.jpg",
      alt: "Vinoteca Madrid wine bar interior"
    }]
  },
  twitter: {
    ...
    title: "Vinoteca Madrid - Authentic Spanish Wine Experience",
    description: "Discover exceptional Spanish wines in Madrid's premier wine bar. Curated selections, expert pairings, and intimate atmosphere.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763251759907-c79nqvl8.jpg"]
  },
  robots: {
    index: true,
    follow: true
